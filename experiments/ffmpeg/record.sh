...
ffmpeg -f avfoundation -i ":1" -ac 2 -af "pan=mono|c0=c1"  -b:a 128k -hls_flags delete_segments -hls_time 15 -hls_list_size 5 -hls_delete_threshold 2 -hls_segment_filename 'file%03d.ts' live.m3u8
