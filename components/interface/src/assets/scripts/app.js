...
function showQrCode(share) {
    share = typeof share !== 'undefined' ? share : false;
...
document.getElementById('btn-qr-live').addEventListener('click', function() {
	showQrCode(false);
	document.getElementById("btn-qr-live").classList.add("active");
	document.getElementById("btn-qr-share").classList.remove("active");
});

document.getElementById('btn-qr-share').addEventListener('click', function() {
	showQrCode(true);
